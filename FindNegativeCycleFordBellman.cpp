...
namespace GraphProcessing {
  ...
  std::vector<Graph::Vertex> BuildNegativeCycle(const Graph &graph, std::vector<Graph::Vertex> &predecessors,
    ...
    std::vector<Graph::Vertex> negative_cycle;
  ...
  std::vector<Graph::Vertex> GetNegativeCycle(const Graph &graph) {
    const int NOT_SET = 0;
    ...
    std::vector<Graph::Vertex> negative_cycle = BuildNegativeCycle(graph, predecessors, cycle_vertex);
